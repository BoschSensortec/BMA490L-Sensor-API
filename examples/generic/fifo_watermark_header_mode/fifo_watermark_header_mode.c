...
#define BMA490L_FIFO_WATERMARK_LEVEL      UINT16_C(650)
 ...
 */
#define BMA490L_FIFO_ACCEL_FRAME_COUNT    UINT8_C(100)
...
int main(void)
{
     ...
     * 100 * (6 axes bytes + 1 header byte) = 700 bytes */
    ...
    rslt = bma490l_set_fifo_config(BMA490L_FIFO_ACCEL | BMA490L_FIFO_HEADER | BMA490L_FIFO_TIME,
                                   BMA490L_ENABLE,
                                   &bma490l_dev);
    bma490l_error_codes_print_result("bma490l_set_fifo_config", rslt);
    ...
    fifoframe.length = BMA490L_FIFO_RAW_DATA_USER_LENGTH + SENSORTIME_OVERHEAD_BYTE;
    ...
    bma490l_error_codes_print_result("bma490l_set_fifo_wm", rslt);

    rslt = bma490l_get_fifo_wm(&watermark, &bma490l_dev);
    bma490l_error_codes_print_result("bma490l_get_fifo_wm", rslt);
